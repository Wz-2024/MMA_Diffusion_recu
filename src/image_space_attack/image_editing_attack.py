...
pipe_inpaint = StableDiffusionInpaintPipeline.from_pretrained(
    "/data_disk/dyy/models/stable-diffusion-inpainting", # put your model path here
    revision="fp16",
    torch_dtype=torch.float16,
)
pipe_inpaint = pipe_inpaint.to("cuda")
safety_checker = torch.load("/data_disk/dyy/python_projects/MMA-Diffusion/datasets/safety_checker.pt") # please download the "safety_checker.pt" from the hugging_face page listed in README.md
